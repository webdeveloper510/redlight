                ...
                <Container>
                    <Row>
                        ...
                        <Col md={8} className='sig text-center my-4 bg-white rounded-1 py-5'>
                            ...
                            <div>
                                <p>Are you a provider?<a className='por' href='Register as provider'> Register as provider </a></p>
                            </div>
                            <Form.Group controlId="kindOfStand" className='d-flex justify-content-center'>
                                <Form.Check
                                    value="3"
                                    type="radio"
                                    aria-label="radio 1"
                                ...
                                <Col md={6}>
                                    <div className='rec'>
                                        <Form.Group className="   mb-3" controlId="formBasicEmail">
                                            <Form.Control type="text" value={values.first_name} onChange={set('first_name')} placeholder="First Name" />
                                        </Form.Group>
                                        <Form.Group className="  mb-3" controlId="formBasicPassword">
                                            <Form.Control type="text" value={values.last_name} onChange={set('last_name')} placeholder="Last Name" />
                                        </Form.Group>
                                        <Form.Group className="  mb-3" controlId="formBasicPassword">
                                        ...
                                        <div className='mb-3'>
                                            ...
                                            <a className='hel mt-3' href='Help Protect my Privacy'> Help Protect my Privacy</a>
                                        </div>
                                        <Form.Group className="  mb-3" controlId="formBasicPassword">
                                        ...
                                        <Form.Group className="  mb-3" controlId="formBasicPassword">
                                            <Form.Select aria-label="Default select example">
                                                ...
                                                <option value="1">Search Engine</option><option value="4">Website</option><option value="2">Word of Mouth</option><option value="3">Friend</option><option value="27">Reddit</option><option value="20">Hustler Publications</option><option value="26">PhatzRadio</option><option value="999">Other - Indicate Below</option>
                                            </Form.Select>
                                        </Form.Group>
                                        <Form.Group className="  mb-3" controlId="formBasicPassword">
                                            <Form.Select aria-label="Default select example">
                                                <option value="Dateline Standard Time">(UTC-12:00) International Date Line West</option><option value="UTC-11">(UTC-11:00) Coordinated Universal Time-11</option>

                                                <option value="Aleutian Standard Time">(UTC-10:00) Aleutian Islands</option>
                                                <option value="Hawaiian Standard Time">(UTC-10:00) Hawaii</option><option value="Marquesas Standard Time">(UTC-09:30) Marquesas Islands</option>
                                                <option value="Alaskan Standard Time">(UTC-09:00) Alaska</option><option value="UTC-09">(UTC-09:00) Coordinated Universal Time-09</option>
                                                ...
                                                <option value="Yukon Standard Time">(UTC-07:00) Yukon</option><option value="Central America Standard Time">(UTC-06:00) Central America</option>
                                                ...
                                                <option value="Azores Standard Time">(UTC-01:00) Azores</option><option value="Cape Verde Standard Time">(UTC-01:00) Cabo Verde Is.</option>
                                                <option value="UTC">(UTC) Coordinated Universal Time</option><option value="GMT Standard Time">(UTC+00:00) Dublin, Edinburgh, Lisbon, London</option><option value="Greenwich Standard Time">(UTC+00:00) Monrovia, Reykjavik</option><option value="Sao Tome Standard Time">(UTC+00:00) Sao Tome</option><option value="Morocco Standard Time">(UTC+01:00) Casablanca</option><option value="W. Europe Standard Time">(UTC+01:00) Amsterdam, Berlin, Bern, Rome, Stockholm, Vienna</option><option value="Central Europe Standard Time">(UTC+01:00) Belgrade, Bratislava, Budapest, Ljubljana, Prague</option><option value="Romance Standard Time">(UTC+01:00) Brussels, Copenhagen, Madrid, Paris</option><option value="Central European Standard Time">(UTC+01:00) Sarajevo, Skopje, Warsaw, Zagreb</option>
                                                ...
                                                <option value="India Standard Time" selected="">(UTC+05:30) Chennai, Kolkata, Mumbai, New Delhi</option>
                                            ...
                                            <Form.Group className=" mb-3" controlId="formBasicPassword">
                                                <Form.Check type="checkbox" className='ch'>
                                                    <label>
                                                        ...
                                                        <a className='agree ' href='I agree to terms and conditions'> I agree to terms and conditions</a>
                                                    </label>
                                                </Form.Check>
                                            </Form.Group>
                                            <Button className='subb me-3' variant="success" onClick={() => submitForm()}>Submit </Button>
                                            <Button className='clear' variant="outline-success">Clear</Button>{' '}
                                        </Form>
                                    </div>
                                </Col>
                                <Col></Col>
